...
| 7   | Story tests                        | `npm run test-storybook --workspace=@mandarin/frontend; npm run check:registry-stories; npm run check:module-boundaries`                                                                                                                                                                                         | stories changed / always at merge |
