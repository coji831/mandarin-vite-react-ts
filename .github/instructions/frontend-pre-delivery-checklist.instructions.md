...
- [ ] Utility class preference — don't create custom CSS if 3+ utility classes achieve the same layout
...
- [ ] Storybook story exists for new components (covers all visual states)
- [ ] `npx @google/design.md lint DESIGN.md` passes
- [ ] `npm run lint` — 0 errors (0 warnings preferred)
- [ ] Existing tests pass — `npm test` (or `npm run test:full` for full suite)
