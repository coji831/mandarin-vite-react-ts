...
import GamificationService from "../../../src/core/services/GamificationService.js";
...
describe("GamificationService", () => {
  ...
  describe("checkAndAwardBadges", () => {
    it("should award 7-day badge when reaching 7 days", async () => {
      ...
      mockBadgeRepo.hasUserBadge.mockResolvedValue(false);
    ...
    it("should not award badges when streak is below lowest milestone", async () => {
      ...
      expect(result).toHaveLength(0);
      expect(mockBadgeRepo.hasUserBadge).not.toHaveBeenCalled();
    });
  });
  ...
  describe("calculateXP", () => {
    it("should award base XP (10) for correct answer without streak bonus", () => {
      ...
      const xp = gamificationService.calculateXP(isCorrect, currentStreak);
  ...
  describe("checkMysteryBoxDrop", () => {
    ...
    it("should not drop mystery box on non-milestone 7-day positions", () => {
      const nonMilestones = [1, 6, 8, 13, 15, 20, 22, 29];
