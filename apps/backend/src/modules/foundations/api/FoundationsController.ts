...
export class FoundationsController {
  private foundationsService: import("../services/FoundationsService.js").FoundationsService;

  constructor(foundationsService: import("../services/FoundationsService.js").FoundationsService) {
