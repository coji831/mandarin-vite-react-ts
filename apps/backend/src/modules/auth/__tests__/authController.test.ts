...
vi.mock("../../../shared/config/index.js", () => {
  const mockConfig = {
    ...
    googleTtsCredentials: { client_email: "test@example.com" },
    geminiCredentials: { client_email: "test@example.com" },
    gcsCredentials: { client_email: "test@example.com" },
  };
...
describe("AuthController", () => {
  ...
  describe("refresh", () => {
    ...
    it("should use refresh token from cookies", async () => {
      mockReq.cookies = { refreshToken: "manualRefresh123" };
  ...
  describe("logout", () => {
    ...
    it("should use refresh token from cookies for logout", async () => {
      mockReq.cookies = { refreshToken: "cookieToken456" };
      mockAuthService.logout.mockResolvedValue();

      await authController.logout(mockReq, mockRes);

      expect(mockAuthService.logout).toHaveBeenCalledWith("cookieToken456");
