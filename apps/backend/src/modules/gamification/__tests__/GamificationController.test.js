/**
 * @file modules/gamification/__tests__/GamificationController.test.js
 * @description Unit tests for GamificationController
 * Tests HTTP handlers for streak and badge endpoints
 */

import { describe, it, expect, beforeEach, vi } from "vitest";
import GamificationController from "../api/GamificationController.js";
...
describe("GamificationController", () => {
  ...
  beforeEach(() => {
    ...
    // userId set by auth middleware, not req.user.id
    mockRequest = {
      userId: "user123",
      body: {},
    };
