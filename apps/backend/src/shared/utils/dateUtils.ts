 ...
 * @param date - The date to calculate end of day for (defaults to today)
 * @returns ISO string set to 23:59:59.999 of the given day
 */
export function getEndOfDay(date: string | Date = new Date()): string {
