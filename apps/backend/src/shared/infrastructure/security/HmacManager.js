 ...
 * Reads EXAMPLES_CACHE_HMAC_KEY (required) and EXAMPLES_CACHE_HMAC_KEY_PREVIOUS (optional) from config
 */
...
export class HmacManager {
  constructor() {
    ...
    this.activeKey = config.examplesCacheHmacKey;
    this.previousKey = config.examplesCacheHmacKeyPrevious || null;
