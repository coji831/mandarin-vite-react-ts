 ...
 *
 * Endpoints:
 * - GET  /api/v1/learning/leeches  - Fetch struggling vocabulary (leeches)
 * - GET  /api/v1/learning/due      - Fetch words due for review (stateless)
 * - POST /api/v1/learning/result   - Save quiz answer and update spaced repetition
 */
...
export class LearningController {
  ...
  /**
   * Get words due for review (stateless - bypasses session management)
