...
export function StrokeReferenceContent() {
  ...
  if (isLoading) {
    return (
      <>
        <section className="stroke-ref-section">
          <h3 className="stroke-ref-heading">The 8 Basic Strokes</h3>
          <p className="stroke-ref-subtitle">Learn by sight — no writing required</p>
          <div className="stroke-ref-loading">
  ...
  return (
    <>
      ...
      <section className="stroke-ref-section">
        <h3 className="stroke-ref-heading">The 4 Stroke Order Rules</h3>
        <StrokeRulesList rules={data.strokeOrderRules} />
      </section>

      <p className="stroke-ref-tip">
