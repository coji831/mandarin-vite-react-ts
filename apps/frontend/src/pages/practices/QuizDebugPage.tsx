...
import { useQuizSessionStore, QuizRouter, Timer, QuizProgressBar } from "../../features/quiz";
import type { QuizQuestion, AnswerResult } from "../../features/quiz";
import "./QuizDebugPage.css";
