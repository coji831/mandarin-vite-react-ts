...
/*
 ...
 Usage:
  node scripts/automate-cleanup-legacy.js    # runs scan and writes report to scripts/cleanup-report.json
  node scripts/automate-cleanup-legacy.js --json  # prints JSON to stdout
