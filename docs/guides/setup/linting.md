...
> **When to read this:** When setting up linting and formatting for the first time, adding new lint rules, troubleshooting ESLint or Prettier configuration issues, or enabling pre-commit hooks.
...
Confirm linting is configured correctly:
...
**Expected result:** `npm run lint` exits with code 0, indicating no linting errors.
