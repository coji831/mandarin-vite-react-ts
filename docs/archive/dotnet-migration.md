...
> **⚠️ ARCHIVED:** This document contains future migration planning reference and is not actively maintained. The .NET backend migration (Epic 14) has not been started and is currently on hold.
