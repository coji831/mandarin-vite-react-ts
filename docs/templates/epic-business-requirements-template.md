...
1. #[ISSUE-NUMBER] / **Story Title** _(link to `story-[EPIC-NUM]-[STORY-NUM]-[SHORT-TITLE].md`)_
   - As a [user role], I want to [action/feature], so that [benefit/value].

2. #[ISSUE-NUMBER] / **Story Title** _(link to `story-[EPIC-NUM]-[STORY-NUM]-[SHORT-TITLE].md`)_
   - As a [user role], I want to [action/feature], so that [benefit/value].

3. #[ISSUE-NUMBER] / **Story Title** _(link to `story-[EPIC-NUM]-[STORY-NUM]-[SHORT-TITLE].md`)_
   - As a [user role], I want to [action/feature], so that [benefit/value].
...
Write Acceptance Criteria as a Markdown task-list (checkboxes). Each checklist item should be short, actionable, and testable. The number of items is not fixed â€” add as many checklist lines as you need for the epic.
...
- Risk: <RISK_SUMMARY> â€” Severity: <High/Medium/Low>
  - Mitigation: <CONCRETE_STEPS>
  - Rollback: <RESTORE_INSTRUCTIONS>

- Risk: <ANOTHER_RISK> â€” Severity: <High/Medium/Low>
  - Mitigation: <CONCRETE_STEPS>
  - Rollback: <RESTORE_INSTRUCTIONS>
