...
graph TD
  ...
  L7 -.gitignored.-> W[wip/ + verification-artifacts/ — pointer rows only]
```
...
- [Layer 7 · Working / Evidence — active · 2 leaves](#layer-7)
...
<details id="layer-7"><summary>Layer 7 · Working / Evidence — active · 2 leaves</summary>
...
| Working docs (WIP) — gitignored working/tracking folder; pointers only | — | [wip/README.md](../wip/README.md) |
