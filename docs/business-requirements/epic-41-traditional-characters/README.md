---
purpose: Global Simplified↔Traditional character toggle for Phase 4 learners
status: deferred
last-verified: 2026-08-17
---

# Epic 41: Traditional Character Toggle
...
**Status:** Deferred — Phase-4, out of 25–40 scope, not scheduled in this plan
...
1. **Story 41.1: Character Mapping Data**
...
2. **Story 41.2: Toggle UI & Global State**
...
- **Story 41.1** creates the character mapping dataset (likely an open-source mapping table)
- **Story 41.2** implements the global toggle UI and state management

Story 41.1 must be completed first since the UI depends on the mapping data to function.
