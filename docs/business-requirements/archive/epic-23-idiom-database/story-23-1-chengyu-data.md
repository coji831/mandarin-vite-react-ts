...
8. **`segments` token schema** — example tokens follow the normative `segments` token schema defined in the story-23.1 IMP (`../../../issue-implementation/archive/epic-23-idiom-database/story-23-1-chengyu-data.md`); **no runtime segmenter** (pre-segmented at authoring time).
...
- **Implementation (IMP twin):** `story-23-1-chengyu-data.md` → `../../../issue-implementation/archive/epic-23-idiom-database/story-23-1-chengyu-data.md`
...
- **Cultural/historical accuracy of the idiom origin stories (Severity: High)** + **a ≥50-idiom set feeling thin for a Phase 4 learner** (the authored set lands at exactly 55) — full write-up in the story-23.1 IMP Technical Challenges & Solutions: `../../../issue-implementation/archive/epic-23-idiom-database/story-23-1-chengyu-data.md`
