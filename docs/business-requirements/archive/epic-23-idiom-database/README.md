...
- Decision: Content naming & narrative fields — camelCase fields + `cy_XXXX` keys; `story`/`storySource` (chosen)
  ...
  - Implications: Single canonical field vocabulary — the full field list lives in the story-23.2 IMP endpoint contract (`../../../issue-implementation/archive/epic-23-idiom-database/story-23-2-chengyu-backend-api.md`); used identically in the BR, all story BRs/IMPs, seed JSON, API contract, and frontend types.
...
- **UI delivery pointers** — the detail-view (`ChengyuHub`) and audio decisions moved to the owning story IMP: `story-23-3-chengyu-ui.md` → `../../../issue-implementation/archive/epic-23-idiom-database/story-23-3-chengyu-ui.md`
...
- **Prisma models** — `Chengyu`/`ChengyuExample`/`ChengyuRelation` DDL + `segments` token schema + migration → story-23.1 IMP: `../../../issue-implementation/archive/epic-23-idiom-database/story-23-1-chengyu-data.md`
- **API endpoint contracts** — `GET /v1/chengyu/idioms` + `GET /v1/chengyu/idioms/:id` (**shipped in story 23.2**, added verbatim to `ROUTE_PATTERNS`; full request/response JSON, error convention) → story-23.2 IMP: `../../../issue-implementation/archive/epic-23-idiom-database/story-23-2-chengyu-backend-api.md`
...
- **Frontend component inventory / hub wiring** → story-23.3 IMP: `../../../issue-implementation/archive/epic-23-idiom-database/story-23-3-chengyu-ui.md`
...
1. **Story 23.1 — Chengyu Data** → [story-23-1-chengyu-data.md](story-23-1-chengyu-data.md) (BR) · [IMP](../../../issue-implementation/archive/epic-23-idiom-database/story-23-1-chengyu-data.md)
2. **Story 23.2 — Chengyu Backend API** → [story-23-2-chengyu-backend-api.md](story-23-2-chengyu-backend-api.md) (BR) · [IMP](../../../issue-implementation/archive/epic-23-idiom-database/story-23-2-chengyu-backend-api.md)
3. **Story 23.3 — Chengyu UI** → [story-23-3-chengyu-ui.md](story-23-3-chengyu-ui.md) (BR) · [IMP](../../../issue-implementation/archive/epic-23-idiom-database/story-23-3-chengyu-ui.md)
