...
- **Implementation (IMP twin):** `story-23-2-chengyu-backend-api.md` → `../../../issue-implementation/archive/epic-23-idiom-database/story-23-2-chengyu-backend-api.md`
...
- **Backend API failure mode vs. static JSON (Severity: Low)** + **the `segments`/`related` null-guard hardening** — full write-up in the story-23.2 IMP Technical Challenges & Solutions: `../../../issue-implementation/archive/epic-23-idiom-database/story-23-2-chengyu-backend-api.md`
