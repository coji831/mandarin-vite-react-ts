...
- **Audio playback redesign proposal (PARKED)** — Design proposal recorded as a gitignored verification artifact (NOT a committed source). Step 1 (implementation) has not started.
