...
- Recommended options:
  ...
  See shared runtime notes: `docs/issue-implementation/archive/epic-8-conversation-generation/runtime-notes.md` for the canonical id format, cache paths, and endpoints used by the running code.
