...
The normative, complete Prisma definitions live in the IMP doc (`docs/issue-implementation/archive/epic-22-grammar-library/README.md` → "Complete Prisma Model Definitions"). This is the field-level contract summary for planning and cross-story alignment.
