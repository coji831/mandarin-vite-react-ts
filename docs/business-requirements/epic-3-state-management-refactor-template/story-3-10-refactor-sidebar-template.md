# Story 3-10: Refactor Sidebar to Use Context (Business Requirement)

## Story Summary

Refactor the `Sidebar` component to consume Mandarin context directly, removing all progress-related props for a cleaner interface.
