...
- **Backend CORS Configuration**: [Backend Architecture](../backend/backend-architecture.md#cors-configuration)
- **Cookie Security**: [Backend Authentication](../backend/backend-authentication.md#cookie-based-sessions)
- **Production Deployment**: [Deployment Strategies](../infrastructure/infra-deployment.md#reverse-proxies)
