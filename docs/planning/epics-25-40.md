...
Reviewed: `wip/guest-access-calibration.md` (§5 plan + guards, §3 from-scratch tracking T1–T20, §4 AI roadmap E.0–E.5/T2.1–T2.6, §25 pivot L1–L8), `wip/tech-mapping.md` (§6.1 epic-scope additions + 4 satellite carve-outs, rows 10/11b/11c), `wip/production-readiness.md` (P1–P10 + epic-39), and `docs/business/business-model.md` (ratified L-series, P11-AMEND, Appendix B). Locked constraints honored unchanged: D1=NestJS 11, D7=shell-swap parallel with 25–28 (29/30/31 land on NestJS), P0-1 first gate, P0-2 re-based as data prerequisite, 4 satellite carve-outs, business-deferred items kept out of scope.
