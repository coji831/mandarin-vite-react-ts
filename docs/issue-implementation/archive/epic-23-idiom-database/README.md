...
**BR Reference:** `../../../business-requirements/archive/epic-23-idiom-database/README.md`
...
**Browser full-flow test: PASS-with-issues** (screenshots recorded as gitignored verification artifacts) — BUG-1 (pagination) fixed in `c1b1c7b2`; BUG-2 (900px responsive) is a pre-existing app-wide pattern, deferred.
