...
- If user data loss occurs (unexpected reset), provide scripts to re-ingest CSV data and document the process in `docs/issue-implementation/archive/epic-9-state-performance-core/restore.md` (create as-needed during recovery).
