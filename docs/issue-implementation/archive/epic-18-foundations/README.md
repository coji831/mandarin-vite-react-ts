...
**BR Reference:** `docs/business-requirements/archive/epic-18-foundations/README.md`
...
2. Stroke Animations:
   User types "?" ? Search ? hanzi-writer renders SVG animation
...
POST /api/v1/progression/quiz-attempts/:id/answers
  ...
  Body: { pinyinInput: "ma", selectedTone: 1, correctTone: 1, correctPinyin: "ma" }
...
FoundationsPage (route: /learn/foundations)
  ...
  +-- StrokeAnimTab (route: /learn/foundations#animations)
      ...
      +-- SuggestedCharacters (?????????? ? quick select)
...
Phase1QuizPage (route: /practices/quiz?type=audio-to-type)
  ...
  +-- ToneSelector (5 buttons: ¯1st ´2nd ?3rd `4th ·0)
...
{
  "tones": [
    { "number": 1, "mark": "¯", "name": "ma", "description": "high level", "contour": [5, 5, 5] },
    { "number": 2, "mark": "´", "name": "má", "description": "rising", "contour": [3, 5, 5] },
    {
      "number": 3,
      "mark": "?",
      "name": "ma",
    ...
    { "number": 4, "mark": "`", "name": "mà", "description": "falling", "contour": [5, 1, 1] },
    { "number": 0, "mark": "·", "name": "ma", "description": "light/neutral", "contour": [3, 3, 3] }
  ],
  "pairDrills": [{ "syllables": "ni hao", "chinese": "??", "rule": "3rd+3rd ? 2nd+3rd" }],
  "changeRules": [
    { "char": "?", "rule": "yi ? yí before 4th tone", "examples": ["?? yí gè"] },
    { "char": "?", "rule": "bù ? bú before 4th tone", "examples": ["?? bú shì"] },
    { "rule": "3rd+3rd ? 2nd+3rd", "examples": ["?? ní hao", "?? hen hao"] }
  ]
}
```
...
{
  "basicStrokes": [
    { "glyph": "?", "pinyin": "dian", "meaning": "dot" },
    { "glyph": "?", "pinyin": "héng", "meaning": "horizontal" },
    { "glyph": "?", "pinyin": "shù", "meaning": "vertical" },
    { "glyph": "?", "pinyin": "pie", "meaning": "left-falling" },
    { "glyph": "?", "pinyin": "nà", "meaning": "right-falling" },
    { "glyph": "?", "pinyin": "tí", "meaning": "rising" },
    { "glyph": "?", "pinyin": "zhé", "meaning": "bend" },
    { "glyph": "?", "pinyin": "gou", "meaning": "hook" }
  ],
  "rules": [
    {
      "name": "Top ? Bottom",
    ...
    { "name": "Outside ? Inside", "example": "?", "description": "frame before contents" },
    { "name": "Close frame last", "example": "?", "description": "fill then close" }
  ],
  "suggestedCharacters": ["?", "?", "?", "?", "?", "?", "?", "?", "?", "?"]
}
```
