...
**BR Reference:** `../../../business-requirements/archive/epic-22-grammar-library/README.md`
...
- **Gates:** all 6 pass (build / lint / design-audit / check:registry-stories / `npm test` / test-storybook) — results recorded as gitignored verification artifacts. **Browser check:** 5/5 pass — evidence recorded as gitignored verification artifacts (+ screenshots).
