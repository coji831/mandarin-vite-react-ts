...
**BR Reference:** `docs/business-requirements/archive/epic-19-radicals/README.md`
...
| 19.2 — Radical Detail Card                              | ✅ Completed | —                                                                                              |
...
| 19.7 — Radical Review & Quiz Strategies                 | ✅ Completed | [story-19-7-radical-review-quiz-strategies.md](./story-19-7-radical-review-quiz-strategies.md) |
...
- [Epic 19 BR](docs/business-requirements/archive/epic-19-radicals/README.md) — Business requirements and user stories
- [Shared Data Model](docs/knowledge-base/data/shared-data-model.md) — RadicalProgress Prisma model schema and shared entities
- [Epic 18 Implementation](docs/issue-implementation/archive/epic-18-foundations/README.md) — Reference for progression module pattern, QuizAttempt/PhaseGate models
