...
- See `docs/issue-implementation/archive/epic-8-conversation-generation/runtime-notes.md` for canonical id formats, cache paths, and canonical endpoints used by the codebase.
