...
const REGENERATION_TIPS: Record<string, string> = {
  pictograph: "Ask for a story that emphasizes visual imagery and the object this character depicts.",
  phono_semantic: "Ask for a story that connects the sound clue to the meaning clue.",
  compound_ideograph: "Ask for a story that explains how the components combine to create the meaning.",
