...
- **Story 23.2 (Chengyu Backend API)** — `modules/chengyu/` + two PROPOSED endpoints + `ROUTE_PATTERNS` + manifest verification + MSW handlers. → `story-23-2-chengyu-backend-api.md`
